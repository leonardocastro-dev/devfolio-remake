...
export default function ContactForm() {
  ...
  if (status === 'success') {
    return (
      <div className="flex flex-col items-center lg:py-4 py-9 px-7 lg:px-9 justify-center border-r border-primary-200 scrollbar-section max-h-full 2xl:pt-72 2xl:justify-start">
  ...
  return (
    <form
      ...
      className="flex flex-col items-center lg:py-4 py-9 px-7 lg:px-9 justify-center border-r border-primary-200 scrollbar-section max-h-full 2xl:pt-30 2xl:justify-start"
    >
