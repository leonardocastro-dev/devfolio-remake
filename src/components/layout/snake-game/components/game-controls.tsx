...
export function GameControls({ foodCollected }: GameControlsProps) {
  return (
    <div className="flex flex-col justify-between">
      <div className="flex flex-col gap-5">
        <div className="rounded-xl bg-primary-400/19 px-3 py-4">
          ...
          <div className="mt-4 grid grid-cols-3 gap-1">
            ...
            <div></div>
            <div className="arrow-key">
              <Icon icon="arrow-key" className="rotate-270" />
            </div>
            <div className="arrow-key">
              <Icon icon="arrow-key" className="rotate-180" />
            </div>
            <div className="arrow-key">
              <Icon icon="arrow-key" className="rotate-90" />
            </div>
          </div>
        </div>
        <div>
